...
function generateComponentClass(componentName, templateName, compInitCode, compControlCode, compEventCode, routeVars, forVars) {
...
function getInitParams(templateElement, paramType, withValue=true, separator='=') {
    let args = []
    if (templateElement) {
